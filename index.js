...
Function `certificatesByNameSelector` has 77 lines of code (exceeds 25 allowed). Consider refactoring.
...
`reducer` has 25 functions (exceeds 20 allowed). Consider refactoring.
  {
